...
def decide_action(
    ...
    if high_risk or classification.confidence < confidence_threshold:
        return high_risk, Action.HUMAN_NEED
    if classification.theme in AUTO_REPLY_THEMES:
        return False, Action.AUTO_REPLY
    return False, Action.APPROVE_REQUIRE
